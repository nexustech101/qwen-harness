...
def save_cached(path: Path, result: dict, root: Path = Path(".")) -> None:
    ...
    Stores as .graph-out/cache/{hash}.json where hash = SHA256 of current file contents.
...
def check_semantic_cache(
    ...
    Uncached files need semantic extraction; cached files are merged directly.
    """
